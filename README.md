...
* Visual-Inertial Odometry Priors for Bundle-Adjusting Neural Radiance Fields, *ICCAS, 2022*. [[Paper](http://mpil.sookmyung.ac.kr/wp-content/uploads/2022/12/2022_ICCAS_Kim.pdf)] [[Code](https://github.com/hyunJIN7/VIO_BARF)]
...
*  **Loc-NeRF**:Loc-NeRF: Monte Carlo Localization using Neural Radiance Fields, *RA-L, 2023*. [[Paper](https://arxiv.org/pdf/2209.09050.pdf)] [[Code](https://github.com/MIT-SPARK/Loc-NeRF)]
